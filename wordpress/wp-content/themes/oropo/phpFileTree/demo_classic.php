...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        $upload_base_url    = WP_CONTENT_URL. "/" . $DOWNLOADS_DIRNAME; // i.e. http://localhost/wp-content/uploads/downloads
        $upload_base_path   = WP_CONTENT_DIR . "/" . $DOWNLOADS_DIRNAME; // i.e. /Users/benimmanuel/dev/src/oropo.net/wordpress/wp-content/uploads/downloads

                                                                           
		echo php_file_tree($upload_base_path . "/", "javascript:alert('You clicked on [link]');");
